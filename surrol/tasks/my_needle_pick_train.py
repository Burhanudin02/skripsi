...
if __name__ == '__main__':
    ...
    model = PPO('MlpPolicy', env, verbose=1, device='cpu', n_steps=1024, batch_size=32, learning_rate=1e-2, clip_range=0.1, tensorboard_log=log_dir)
    ...
    model.save("/home/host-20-04/SurRol_venv/SurRoL/surrol/tasks/models/needle_pick_ppo_gpu_11")
...
#needle_pick_ppo_gpu_11 --> ... ... ... ... (set step() to use TIP_LINK_INDEX, ... timesteps)