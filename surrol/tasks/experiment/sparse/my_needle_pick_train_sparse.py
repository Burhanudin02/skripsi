...
if __name__ == '__main__':
    ...
    log_dir = "/data/skripsi/surrol/tasks/experiment/sparse/logs"

    base_path = "/data/skripsi/surrol/tasks/experiment/sparse/models/"
    ...
    agent_index = 16     # index model awal yang akan diload untuk re-train
    jumlah_retrain = 3
