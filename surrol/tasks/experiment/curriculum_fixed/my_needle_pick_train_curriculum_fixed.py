...
if __name__ == '__main__':
    ...
    log_dir = "/media/ataka/toshiba-burhan/skripsi/surrol/tasks/experiment/curriculum_fixed/logs"

    base_path = "/media/ataka/toshiba-burhan/skripsi/surrol/tasks/experiment/curriculum_fixed/models/"
